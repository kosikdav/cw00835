...
$ADCredentialPath = "C:\cred\qp_m365uploader\qp_m365uploader.cred"
...
get-childitem $UNC -Recurse | % { $_.FullName }
...
$SPOFolder = "Provoz_cinnosti/VYROBA/PrehledVelicin/EST"

Request-MSALToken -AppRegName "CEZ_SPO_FILEUPLOADER" -TTL 30
...
$Drives = Get-GraphOutputREST -Uri $Uri -AccessToken $AuthDB["CEZ_SPO_FILEUPLOADER"].AccessToken -ContentType $ContentTypeJSON
