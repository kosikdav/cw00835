...
$RootODfBURL        = "https://ujvrez-my.sharepoint.com/personal"
...
$GuestUPNSuffix     = "#ext#@ujvrez.onmicrosoft.com"
$DelGuestUPNSuffix  = "#ext#_ujvrez_onmicrosoft_com"
...
$AppReg_SPO_REPORT_PnP      = "UJVREZ_SPO_REPORTS_PnP"
...
$DBFileEXOMboxMgmt          = "d:\data\mailbox-mgmt\mailbox-mgmt-db.xml"
...
$NoEnumerationGroups = @(
	"db778248-488f-4d92-b0a0-2d2043855c4c",
	"4277d8d7-c0e1-426b-952d-7bc9ddd2cc99"
)
